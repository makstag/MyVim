...
km.set("n", "<C-j>", "<C-w>j")
km.set("n", "<C-l>", "<C-w>l")
km.set("n", "<leader>j", "<Cmd>:bprevious<CR>", opts)
km.set("n", "<leader>k", "<Cmd>:bnext<CR>", opts)
km.set("n", "<leader>q", "<Cmd>:bprevious<CR>:bdelete #<CR>", opts)
km.set("n", "<leader>y", "<Cmd>:%y<CR>")
km.set("n", "k", "gk", opts)
km.set("n", "j", "gj", opts)
km.set("n", "<leader>l", "<Cmd>:vsplit term://zsh <CR>", opts)
km.set("t", "<leader><Esc>", "<C-\\><C-n>", opts)
km.set("n", "<leader>v", "<Cmd>:edit ~/.config/nvim/init.lua<CR>", opts)
